    ...
    <div className="min-h-screen bg-white text-gray-900 font-sans selection:bg-blue-100 selection:text-blue-900 overflow-x-hidden">
      ...
      <nav className={`fixed top-0 w-full z-50 transition-all duration-500 ${
        ...
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          ...
          >
            <Link to="/login" className="hidden sm:block text-sm font-bold text-gray-600 hover:text-blue-600 transition-colors px-4 py-2">
              Sign In
            </Link>
            <Link to="/signup" className="bg-gray-900 hover:bg-blue-600 text-white px-6 py-2.5 rounded-xl text-sm font-bold transition-all shadow-lg hover:shadow-blue-600/20 active:scale-95">
              Get Started
            </Link>
          </motion.div>
        </div>
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        <div className="absolute top-0 right-0 -z-10 w-[800px] h-[800px] bg-blue-50 rounded-full blur-[120px] opacity-70 translate-x-1/3 -translate-y-1/4 pointer-events-none"></div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            >
              <div className="inline-flex items-center gap-2 bg-blue-50 text-blue-600 px-4 py-2 rounded-full text-xs font-black mb-8 uppercase tracking-widest border border-blue-100">
                <span className="w-2 h-2 rounded-full bg-blue-600 animate-pulse"></span>
                Property Management OS
              </div>
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-black tracking-tight text-gray-900 mb-6 leading-[1.05]">
                Track your property.<br />
                <span className="text-blue-600">Manage with clarity.</span>
              </h1>
              <p className="text-lg md:text-xl text-gray-500 mb-10 font-medium leading-relaxed max-w-2xl mx-auto lg:mx-0">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start">
                <Link to="/signup" className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-2xl text-lg font-bold transition-all shadow-xl shadow-blue-600/20 flex items-center justify-center gap-2 group active:scale-95">
                  Get Started Now
                  <ArrowRight className="group-hover:translate-x-1 transition-transform" size={20} />
                </Link>
                <Link to="/login" className="w-full sm:w-auto bg-white hover:bg-gray-50 text-gray-700 border border-gray-200 px-8 py-4 rounded-2xl text-lg font-bold transition-all flex items-center justify-center active:scale-95">
                  Sign In
                </Link>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="relative w-full aspect-square md:aspect-[4/3] rounded-[2.5rem] bg-gradient-to-br from-blue-50 to-indigo-50/50 border border-white shadow-2xl shadow-blue-900/5 overflow-hidden flex items-center justify-center">
                <div className="absolute inset-x-4 inset-y-8 md:inset-x-8 md:inset-y-12 bg-white/60 backdrop-blur-xl rounded-3xl shadow-sm border border-white flex flex-col p-6 gap-6">
                  {/* Header */}
                  <div className="flex justify-between items-center">
                    <div className="w-32 h-6 bg-gray-200/50 rounded-full"></div>
                    <div className="w-10 h-10 bg-blue-100 rounded-full"></div>
                  </div>
                  {/* Stats Row */}
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                    {[1, 2, 3].map(i => (
                      <div key={i} className={`h-24 bg-gradient-to-br from-white to-gray-50/50 rounded-2xl border border-white p-4 flex flex-col justify-between shadow-sm ${i === 3 ? 'hidden md:flex' : ''}`}>
                        <div className="w-8 h-8 bg-blue-50 rounded-xl"></div>
                        <div className="w-16 h-3 bg-gray-200/50 rounded-full"></div>
                      </div>
                    ))}
                  </div>
                  {/* Chart Area */}
                  <div className="flex-1 bg-gradient-to-t from-blue-50/30 to-transparent rounded-2xl border border-white relative overflow-hidden flex items-end">
      ...
      <section className="py-24 bg-gray-50 relative">
        <div className="max-w-7xl mx-auto px-6">
          <motion.div {...fadeInUp} className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-black text-gray-900 tracking-tight mb-4">Everything you need to scale</h2>
          ...
          >
            {[
              ...
              <motion.div 
                ...
                className="bg-white p-8 rounded-[2rem] shadow-sm border border-gray-100 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 group"
              >
      ...
      <section className="py-32 bg-white overflow-hidden relative">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-4xl h-[400px] bg-blue-50/50 rounded-full blur-[100px] -z-10 pointer-events-none"></div>
        <div className="max-w-7xl mx-auto px-6">
          <motion.div {...fadeInUp} className="text-center mb-24">
            <h2 className="text-4xl md:text-5xl font-black text-gray-900 tracking-tight mb-6">Built for mobile control</h2>
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-16 md:gap-24">
            ...
            >
              <div className="absolute -inset-4 bg-gradient-to-b from-blue-100/50 to-transparent rounded-[3.5rem] opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur-xl"></div>
              <div className="w-[300px] h-[600px] bg-white rounded-[3rem] shadow-2xl border-[8px] border-gray-900 overflow-hidden relative flex flex-col z-10">
              ...
              <div className="mt-10 text-center">
                <h3 className="text-2xl font-black text-gray-900 mb-2">Tenant Profiles</h3>
                <p className="text-gray-500 font-medium">Complete history at your fingertips.</p>
              </div>
            </motion.div>
            ...
            <motion.div 
              ...
              className="relative group"
            >
              <div className="absolute -inset-4 bg-gradient-to-b from-emerald-100/50 to-transparent rounded-[3.5rem] opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur-xl"></div>
              <div className="w-[300px] h-[600px] bg-white rounded-[3rem] shadow-2xl border-[8px] border-gray-900 overflow-hidden relative flex flex-col z-10">
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-32 h-6 bg-gray-900 rounded-b-3xl z-20"></div>
                  ...
                  {[1, 2].map(i => (
                    <div key={i} className="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 space-y-4">
                      <div className="flex justify-between items-center">
                        ...
                        <div className="w-12 h-4 bg-rose-100 rounded-full"></div>
                      </div>
                      <div className="w-full h-10 bg-emerald-50 rounded-xl flex items-center justify-center">
              ...
              <div className="mt-10 text-center">
                <h3 className="text-2xl font-black text-gray-900 mb-2">Smart Billing</h3>
                <p className="text-gray-500 font-medium">Track every rupee with precision.</p>
              </div>
            </motion.div>
      ...
      <section className="py-32 bg-gray-900 text-white relative overflow-hidden">
        <div className="absolute top-0 right-0 w-full h-full bg-gradient-to-br from-blue-600/20 to-transparent opacity-50"></div>
      ...
      <footer className="bg-white py-12 border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-black tracking-tighter text-gray-900">VeeduLedger</span>
          </div>
          
          <div className="flex items-center gap-8">
            <Link to="/login" className="text-sm font-bold text-gray-500 hover:text-blue-600 transition-colors">Login</Link>
            <Link to="/signup" className="text-sm font-bold text-gray-500 hover:text-blue-600 transition-colors">Sign Up</Link>
            <a href="#" className="text-sm font-bold text-gray-500 hover:text-blue-600 transition-colors">Support</a>
          </div>

          <p className="text-sm font-bold text-gray-400 text-center md:text-right">
